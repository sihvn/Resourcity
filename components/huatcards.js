                ...
                <div className="border border-gray-200 rounded-lg shadow p-6">
                    ...
                    <div className="flex justify-center">
                        <div className="flex justify-between mt-4">
                            <button onClick={prevCard1} className="px-1 py-1 bg-white text-black font-bold text-s rounded-md">{'<'}</button>
                        </div>
                        <img src={HuatCardsData[currentCardIndex1].image} alt={HuatCardsData[currentCardIndex1].title} className="w-full px-2 rounded-lg " />
                        <div className="flex justify-between mt-4">
                            <button onClick={nextCard1} className="px-1 py-1 bg-white text-black font-bold  text-s rounded-md">{'>'}</button>
                        </div>
                    </div>
                </div>
            </div>
